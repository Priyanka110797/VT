...
public class CreateOrganizationWithPhoneNumber {
	...
	//String phoneNo=r.getCell(3).toString();//9.999999999E9
	String phoneNo=r.getCell(3).getStringCellValue();
	...
	//Check Page Header Organization information
	String headerinfo=driver.findElement(By.className("dvHeaderText")).getText();
	if(headerinfo.contains(orgName))
		System.out.println(headerinfo+" is verified==PASS");
	else
		System.out.println(headerinfo+" is not verified==FAIL");
